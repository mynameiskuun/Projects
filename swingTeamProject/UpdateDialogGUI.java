...
//		아이디패널
		...
		idPanel.setBounds(85, 50, 90, 60);
		contentPanel.add(idPanel);
		idPanel.setLayout(null);

		JLabel idLabel = new JLabel("아이디");
		idLabel.setBounds(27, 5, 36, 15);
		idPanel.add(idLabel);
...
//		비밀번호패널
		...
		passwordPanel.setBounds(180, 50, 100, 60);
		contentPanel.add(passwordPanel);

		JLabel passwordLabel = new JLabel("비밀번호");
		passwordLabel.setBounds(27, 5, 48, 15);
...
//		전화번호패널
		...
		phoneNumberPanel.setBounds(285, 50, 120, 60);
		contentPanel.add(phoneNumberPanel);

		JLabel phoneNumberLabel = new JLabel("전화번호");
		phoneNumberLabel.setBounds(35, 5, 64, 15);
...
//		이름패널
		...
		namePanel.setBounds(410, 50, 80, 60);
		contentPanel.add(namePanel);

		JLabel nameLabel = new JLabel("이름");
		nameLabel.setBounds(30, 5, 64, 15);
...
//				UpdateDialog에서 입력한 텍스트 값을 관리자테이블에 보여지도록 해줌
				stuManageGUI.table.setValueAt(id, row, 1);
				stuManageGUI.table.setValueAt(password, row, 2);
				stuManageGUI.table.setValueAt(phoneNumber, row, 3);
				stuManageGUI.table.setValueAt(name, row, 4);
...
//				UpdateDialog에서 입력한 텍스트 값을 db메서드로 전송
