...
//		비밀번호패널
		...
		passwordPanel.setBounds(155, 50, 100, 60);
...
//		전화번호패널
		...
		phoneNumberPanel.setBounds(260, 50, 110, 60);
		contentPanel.add(phoneNumberPanel);

		JLabel phoneNumberLabel = new JLabel("전화번호");
		phoneNumberLabel.setBounds(30, 5, 64, 15);
...
//		이름패널
		...
		namePanel.setBounds(375, 50, 80, 60);
		contentPanel.add(namePanel);

		JLabel nameLabel = new JLabel("이름");
		nameLabel.setBounds(27, 5, 64, 15);
...
//		생년월일패널
		...
		birthLabel.setBounds(17, 5, 64, 15);
...
//		수강명패널
		...
		courseNameLabel.setBounds(22, 5, 48, 15);
